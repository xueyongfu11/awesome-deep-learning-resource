...
- DPO跟对比学习有哪些相同点和不同点？
- ROPE给我介绍一下？代码能写下吗?
  - ROPE 把位置编码做成旋转矩阵，直接旋转 Q/K 向量，在点积里自然带上“相对位置信息。

### 多模态

- Q-Former和MLP作为对齐层的对比
- 如何优化CLIP，使其能够提取细粒度的特征而不是全局
- 在多模态预训练中，如何处理图像分辨率过高的问题？关键优化手段有哪些？
- 什么是多模态对齐？它和 RLHF 的关系是怎样的？
- 介绍一下 LLaVA 系列架构的核心原理和主要创新点
- 多模态问答系统如何处理OCR和物体检测信息？这些特征在模型中怎么融合？ 如果 OCR 提取结果错误，会影响问答准确率吗？你如何降低影响？
- 在 LLaVA 的基础上加入分辨率自适应编码器，主要优化的是哪部分的瓶颈？推理速度提升多少？
