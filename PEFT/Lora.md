...
- LoTR: Low Tensor Rank Weight Adaptation
  ...
  - oTR通过将每个层的低秩适配器构建为三个矩阵的乘积，从而在Transformer块中共享左右乘数，从而实现了更好的参数效率
...
Language Models
  - 通过将传统的低秩线性适应（Low-Rank Adaptation，LoRA）推广为低维非线性适应（Low-Dimensional Adaptation，LoDA），提出了一种在参数效率方面具有竞争力的微调方法。
